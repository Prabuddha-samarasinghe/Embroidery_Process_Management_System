...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2022 at 10:49 AM
...
(1, 'BUY000001', 'Mr.', 'Amila Dissanayake', '12322245', '67 2 Dambuwawaththa Kinigama  Buthpitiya', 'amilasissa@gmail.com', 717788845, 717788845, 717766654, 'www.adDesign.com', 'PRABUDDHA ', 717766633, '2021-07-12', '0000-00-00', 0, 0, 'Active'),
...
(6, 'BUY000006', 'Mrs.', 'Kamal Sandaruwan', '12322245', '045 Tissa Avenue Melder Place Nugegoda', 'kamal_ks@gmail.com', 717788845, 717788845, 717766654, 'www.ksgarment.com', 'Sumedaha Kularathne', 776366654, '2021-09-12', '0000-00-00', 0, 0, 'Active'),
(7, 'BUY000007', 'Mrs.', 'Sithum Sisara', '881230996V', '278,  Kandiroad, Peliyagoda', 'sithum@gmail.com', 717788845, 717788845, 717766654, 'www.domgamar.com', 'Namal perera', 717906654, '2021-09-12', '0000-00-00', 0, 0, 'Active'),
...
(10, 'BUY000010', 'Mr.', 'Sudath Perera', '1234', '122,Gampaha', 'sudath@gmail.com', 717788845, 717788845, 355445, 'www.sudath.com', 'Dilshani', 777766886, '2021-09-01', '0000-00-00', 0, 0, 'Active'),
...
(14, 'BUY000014', 'Miss.', 'Ssantha Perera', '07772', '67 2 Dambuwawaththa Kinigama  Buthpitiya', 'prabuddha1986@gmail.com', 717788845, 717788845, 717766654, 'www.ksgarment.com', 'PRABUDDHA LAKMAL SAMARASINGHE', 717766654, '2021-12-11', '0000-00-00', 0, 0, 'Active');
...
(1, 'MAT000001', 'Paddings', 'Meters', 52776, 'Active'),
...
(26, 'SAM000002', 'New Sample added', 'By Tharanga Roopasinghe', '2021-12-11', '11:35:15', 0, ''),
(27, 'SAM000001', 'New Order added', 'By Tharanga Roopasinghe', '2021-12-11', '11:36:34', 1, ''),
(28, 'ORD000002', 'order is Finished', '', '2021-12-11', '11:37:14', 0, ''),
...
(1, 'ORD000001', '2021-10-06', '', ' x', '44.00', 'CD1124', 'X116', 77, ' x', '../order_images/1353596037.png', ' x', 'Ongoing', 'Active'),
(2, 'ORD000002', '2021-10-08', 'BUY000001', ' Pellentesque habitant morbi tristique senectus et netus et ', '0.00', 'CD1124', 'X1s121', 67, 'Habitant morbi tristique senectus et netus et ', '../order_images/1851594752.png', 'senectus et netus et ', 'Finish', 'Active'),
(3, 'ORD000003', '2021-10-06', 'BUY000002', ' In Logic Pro, choose Track', '0.00', 'CD1124', 'X1s121', 150, ' In Logic Pro, choose Track', '../order_images/57057006.png', ' In Logic Pro, choose Track', 'Ongoing', 'Active'),
(4, 'ORD000004', '2021-10-09', 'BUY000003', ' Morbi in sem quis dui placerat ', '0.00', 'C11ss24', 'X1121sd', 70, ' Morbi in sem quis dui placerat ', '../order_images/1548056296.png', ' Morbi in sem quis dui placerat ', 'Ongoing', 'Active'),
(5, 'ORD000005', '2021-10-09', 'BUY000007', ' Lorem ipsum dolor sit amet', '0.00', 'VSD1124', 'XCDs121', 66, ' Lorem ipsum dolor sit amet', '../order_images/744891173.png', ' Lorem ipsum dolor sit amet', 'Finish', 'Active'),
...
(17, 'ORD000016', '2021-12-11', 'BUY000001', ' ss', '55.00', '22', 'X1121', 33, ' ss', '../order_images/579645968.png', ' ss', 'Ongoing', 'Active');
...
(1, 'SAM000001', '2021-12-10', 'ORD000016', 'BUY000001', 'Cap', '../sample_images/874732386.png', 'Active'),
(2, 'SAM000002', '2021-12-11', 'Not yet issue', 'BUY000001', 'Cpa', '../sample_images/1731237624.png', 'Active');
...
--
ALTER TABLE `finished_order_details`
  MODIFY `InternalId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `good_issue_note`
--
ALTER TABLE `good_issue_note`
  MODIFY `InternalId` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `materials`
  MODIFY `InternalId` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `materials_stocks_in`
--
ALTER TABLE `materials_stocks_in`
  MODIFY `InternalId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `notifications`
--
ALTER TABLE `notifications`
  MODIFY `InternalId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `samples`
  MODIFY `InternalIdS` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
